...
function addArray() {
  ...
  end_massange13 = {
    m: "А ещё у меня для Вас отличные новости. Вы прошли онлайн-диагностику и тем самым стали участником розыгрыша этого препарата, который является нашим спонсором. Только сегодня, у Вас есть возможность получить «GiperoPlus» -  <span style='color: #fff; font-weight: 800; text-decoration: underline;'>безплатно</span>.",
  };
  end_massange14 = {
...
function goToServer(){
  document.querySelector(".submit-roulette").addEventListener("click", function() {
    var userName = document.getElementById("name");
    var userNumber = document.getElementById("phone");
    userInfo[0] = genderNext();
    userInfo[1] = appAge();
    userInfo[2] = YsNo();
    userInfo[3] = userName;
    userInfo[4] = userNumber;
  })
}
